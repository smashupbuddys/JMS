/*
  ...
  1. Changes
    - Add enhanced payment details validation
...
-- Drop existing payment validation functions and triggers
...
BEGIN
  ...
  CASE v_payment_status
    WHEN 'completed' THEN
      IF v_pending_amount > 0 OR v_paid_amount != v_total_amount THEN
...
-- Add trigger to validate payment details
