/*
  ...
  1. New Tables
    - `deleted_quotations` - Stores deleted quotations for recovery
      - Inherits structure from quotations table
      - Adds deleted_at timestamp
      - Includes customer and video call references
      
  2. Security
    - Enable RLS on deleted_quotations table
    - Add policies for staff access
    
  3. Changes
    - Add trigger to move quotations to deleted_quotations on delete
    - Add function to restore deleted quotations
*/
